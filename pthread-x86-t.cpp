...
fstream RowFile("xh3.txt", ios::in | ios::out);
fstream BasisFile("xz3.txt", ios::in | ios::out);
...
void reset()
{
    ...
    RowFile.close();
    BasisFile.close();
    RowFile.open("xh3.txt", ios::in | ios::out);
    BasisFile.open("xz3.txt", ios::in | ios::out);
    iToBasis.clear();
