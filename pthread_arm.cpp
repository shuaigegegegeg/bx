...
int main() {
    ...
    printf("pthread-s1： %.2fms\n", (dsec * 1000 + dnsec / 1e6));    
    deleteA();

    cal(neon_dynamic_NUM_THREADS);
    printf("neon-pthread-s1： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();

    cal(LU_sem_static);
    printf("pthread-s2： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();

    cal(sem_static);
    printf("neon-pthread-s2： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();
*/
    cal(LU_sem_tri);
    printf("pthread-s3： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();

    cal(sem_triplecircle);
    printf("neon-pthread-s3： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();
/*
    cal(LU_barrier);
    printf("pthread-s4： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();

    cal(barrier_static);
    printf("neon-pthread-s4： %.2fms\n", (dsec * 1000 + dnsec / 1e6));
    deleteA();
    */
}
